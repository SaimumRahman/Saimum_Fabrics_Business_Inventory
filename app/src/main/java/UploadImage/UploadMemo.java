...
import com.example.groceryapplication.CustomerListModalClass;
...
private Button uploadImageBtns;
...
private ImageView select_memo_images;
    ...
    private String saveCurrentTime,downloadImageUrl,saveCurrentDate,uniquePhns;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        memoRefRef= FirebaseDatabase.getInstance().getReference().child("Customer_Details").child(uniquePhns);
...
//        productMap.put("time",saveCurrentTime);
        ...
        memoRefRef.updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
